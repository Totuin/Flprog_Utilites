...
public:
    ...
    bool digitalRead();
    virtual uint8_t pinNumber() { return 255; };

protected:
    virtual void privateSetPin(uint8_t number) { (void)number; };
...
public:
    ...
    virtual uint8_t pinNumber() { return _structure.pin; };

protected:
    virtual void privateSetPin(uint8_t number) { _structure.setPin(number); };
